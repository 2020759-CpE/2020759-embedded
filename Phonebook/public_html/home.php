            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     ...
                     <p>Creating a phonebook for a website is a useful feature that allows users to access contact information for various individuals or organizations easily. Depending on your website's requirements, you can design a phonebook using various technologies and approaches. Here's a general guide on how to design a phonebook for a website </p>
                  </div>
               </div>
            </div>
         </div>
                           ...
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="clientsl_text">
                                    ...
                                    <h3>Agent Jerou <img src="images/icon.png" alt="#"/></h3>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="clientsl_text">
                                    <i><img src="images/clint.jpg" alt="#"/></i>
                                    <h3>Master Bebic <img src="images/icon.png" alt="#"/></h3>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem IpsumIt is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum</p>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="clientsl_text">
                                    <i><img src="images/clint.jpg" alt="#"/></i>
                                    <h3>Eman <img src="images/icon.png" alt="#"/></h3>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem IpsumIt is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum</p>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-9">
                     <form class="newslatter_form">
                        ...
                        <button class="subs_btn">Subscribe Na</button>
                     </form>
                  </div>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="Informa conta">
                        <h3>contact Us</h3>
                        <ul>
                           <li> <a href="Javascript:void(0)"> <i class="fa fa-map-marker" aria-hidden="true"></i> Pasig City
                              </a>
                           </li>
                           <li> <a href="Javascript:void(0)"><i class="fa fa-phone" aria-hidden="true"></i> Call +639260654899
                              </a>
                           </li>
                           <li> <a href="Javascript:void(0)"> <i class="fa fa-envelope" aria-hidden="true"></i> wackyiverson@gmail.com
                              </a>
                           </li>
                        </ul>
                     </div>
